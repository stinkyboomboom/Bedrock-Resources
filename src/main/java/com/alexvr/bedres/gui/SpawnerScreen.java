...
public class SpawnerScreen extends Screen {
    ...
    protected void init() {
        ...
        addButton(new Button(relX + 10, relY + 20, 160, 20, "Altar", button -> spawn("bedres:altar")));
//        addButton(new Button(relX + 10, relY + 47, 160, 20, "Zombie", button -> spawn("minecraft:zombie")));
//        addButton(new Button(relX + 10, relY + 74, 160, 20, "Cow", button -> spawn("minecraft:cow")));
//        addButton(new Button(relX + 10, relY + 101, 160, 20, "Sheep", button -> spawn("minecraft:sheep")));
//        addButton(new Button(relX + 10, relY + 128, 160, 20, "Chicken", button -> spawn("minecraft:chicken")));
    }
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(font,"Choose a Structure to find:",relX+88,relY+8,16777215);
