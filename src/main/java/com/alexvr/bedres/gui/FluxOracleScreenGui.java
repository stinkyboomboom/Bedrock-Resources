...
public class FluxOracleScreenGui extends Screen {
    ...
    protected void init() {
        ...
        back = new ImageButton(((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/18), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-48)),32,32,0,0,0,
        ...
        next = new ImageButton(((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-48)),32,32,0,0,0,
    ...
    public void genButts(){
        List<AbstractButton> buttons = new ArrayList<AbstractButton>() {{
            ...
            add(new ImageButton((int)xOffset+15+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), (int)yOffset+15+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+64+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+64+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+164+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+46+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+300+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+21+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+106+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+76+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+186+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+66+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+243+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+83+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+243+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+23+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+106+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+28+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+164+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+97+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+32+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+97+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+332+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+97+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+355+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+15+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+64+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+126+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+235+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+143+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+135+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+165+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+385+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+143+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+305+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+173+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
            ...
            add(new ImageButton((int)xOffset+255+ (int)scaleX+((Minecraft.getInstance().getMainWindow().getScaledWidth()-64)/8), (int)yOffset+203+ (int)scaleY+((Minecraft.getInstance().getMainWindow().getScaledHeight()-64)/6),32+ (int)scaleX,32+ (int)scaleY,0,0,0,
    ...
    public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
        ...
        if(main) {
            drawModalRectWithCustomSizedTexture(15, Minecraft.getInstance().getMainWindow().getScaledWidth() - 15, Minecraft.getInstance().getMainWindow().getScaledHeight() - 15, 15, new ResourceLocation("bedres", "textures/gui/flux_oracle_book_gui.png"));
            ...
            this.blit((Minecraft.getInstance().getMainWindow().getScaledWidth()/8)-3, (Minecraft.getInstance().getMainWindow().getScaledWidth()/9)-1, (int)xOffset/2, (int)yOffset/2, (Minecraft.getInstance().getMainWindow().getScaledWidth() - Minecraft.getInstance().getMainWindow().getScaledWidth()/4)+2 , Minecraft.getInstance().getMainWindow().getScaledHeight() - (Minecraft.getInstance().getMainWindow().getScaledWidth()/5)-8);
            for (Widget b : buttons) {
                if (b.x < 46 || b.y< 56 || b.x + b.getWidth() > Minecraft.getInstance().getMainWindow().getScaledWidth() - 46 || b.y + b.getHeight()> Minecraft.getInstance().getMainWindow().getScaledHeight() - 56){
                    continue;
                }
                b.renderButton(p_render_1_, p_render_2_, p_render_3_);
            }
        }else if (scrapes){
            drawModalRectWithCustomSizedTexture(15, Minecraft.getInstance().getMainWindow().getScaledWidth() - 15, Minecraft.getInstance().getMainWindow().getScaledHeight() - 15, 15, new ResourceLocation("bedres", "textures/gui/flux_oracle_book_info_gui.png"));
            drawModalRectWithCustomSizedTexture(5+((Minecraft.getInstance().getMainWindow().getScaledWidth())/8.0f)-32, 5+ ((Minecraft.getInstance().getMainWindow().getScaledWidth())/8.0), (5+((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6.0)) + 32, 5+((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6.0f),
                    new ResourceLocation("bedres", "textures/items/bedrock_scrapes.png"));
            drawString(minecraft.fontRenderer,"Bedrock Scrapes:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            renderString(s,12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),Minecraft.getInstance().getMainWindow().getScaledWidth()-30);
        }else if (knife){
            drawModalRectWithCustomSizedTexture(15, Minecraft.getInstance().getMainWindow().getScaledWidth() - 15, Minecraft.getInstance().getMainWindow().getScaledHeight() - 15, 15, new ResourceLocation("bedres", "textures/gui/flux_oracle_book_info_gui.png"));
            drawModalRectWithCustomSizedTexture(5+((Minecraft.getInstance().getMainWindow().getScaledWidth())/8.0f)-32, 5+ ((Minecraft.getInstance().getMainWindow().getScaledWidth())/8.0), (5+((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6.0)) + 32, 5+((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6.0f),
                    new ResourceLocation("bedres", "textures/gui/widget/scrape_knife.png"));
            drawString(minecraft.fontRenderer,"Scrape Knife:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            drawString(minecraft.fontRenderer,"Altar:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            drawModalRectWithCustomSizedTexture(15, Minecraft.getInstance().getMainWindow().getScaledWidth() - 15, Minecraft.getInstance().getMainWindow().getScaledHeight() - 15, 15, new ResourceLocation("bedres", "textures/gui/flux_oracle_book_info_gui.png"));
            drawModalRectWithCustomSizedTexture(32, Minecraft.getInstance().getMainWindow().getScaledWidth()-32, (Minecraft.getInstance().getMainWindow().getScaledHeight()-32) , 32,
            ...
            renderString(s,12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/8),Minecraft.getInstance().getMainWindow().getScaledWidth()-30);
            next.renderButton(p_render_1_, p_render_2_, p_render_3_);

        }else if (altar4){
            drawModalRectWithCustomSizedTexture(15, Minecraft.getInstance().getMainWindow().getScaledWidth() - 15, Minecraft.getInstance().getMainWindow().getScaledHeight() - 15, 15, new ResourceLocation("bedres", "textures/gui/flux_oracle_book_info_gui.png"));
            drawString(minecraft.fontRenderer,"Recipes:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/8),1111111);
            drawString(minecraft.fontRenderer,"Item A - Item B - Item C -> Output",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/4), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/8),1111111);

            drawString(minecraft.fontRenderer,"Magenta Panes - Compressed Wire - Void Tears -> 1 Gravity Bubble",
                    12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/9),
                    ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/4)-8  ,1111111);
            renderInfusingItems(new ItemStack(Items.MAGENTA_STAINED_GLASS_PANE),new ItemStack(ModBlocks.bedrockCompressedWireBlock),new ItemStack(ModBlocks.voidTears),new ItemStack(ModBlocks.fluxedGravityBubble),
                    12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/9),
                    ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/4)-8);


            drawString(minecraft.fontRenderer,"Gold Ingots - Gold Blocks - Ender Pearl -> 8 Item Platforms",
                    12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/9),
                    (((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/4)+ (Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/10)  ,1111111);
            renderInfusingItems(new ItemStack(Items.GOLD_INGOT),new ItemStack(Blocks.GOLD_BLOCK),new ItemStack(Items.ENDER_PEARL),new ItemStack(ModBlocks.itemPlatform),
                    12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/9),
                    (((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/4)+ (Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/10));

            drawString(minecraft.fontRenderer,"Blazium - Void Tears - Gold Block -> 1 Gravity Staff",
                    12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/9),
                    ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/2)  ,1111111);
            renderInfusingItems(new ItemStack(ModBlocks.blazium),new ItemStack(ModBlocks.voidTears),new ItemStack(Blocks.GOLD_BLOCK),new ItemStack(ModItems.staff),
                    12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/9),
                    ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/2));

            drawString(minecraft.fontRenderer,"Obsidian - Ender Pearl - Gold Ingot -> 8 Enderian Ingots",
                    12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/9),
                    (((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/2)+ (Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/5)-12  ,1111111);
            renderInfusingItems(new ItemStack(Blocks.OBSIDIAN),new ItemStack(Items.ENDER_PEARL),new ItemStack(Items.GOLD_INGOT),new ItemStack(ModItems.enderianIngot),
                    12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/9),
                    (((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/2)+ (Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/5)-12);

            drawString(minecraft.fontRenderer,"Enderian Ingot - Enderian Block - Scraper Mesh -> 1 Scraper Motor",
                    12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/9),
                    (((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/2)+ (Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/4 )+8  ,1111111);
            renderInfusingItems(new ItemStack(ModItems.enderianIngot),new ItemStack(ModBlocks.enderianBlock),new ItemStack(ModItems.mesh),new ItemStack(ModBlocks.motor),
                    12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/9),
                    (((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/2)+ (Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/4 )+8);

        }else if (scraper){
            drawModalRectWithCustomSizedTexture(15, Minecraft.getInstance().getMainWindow().getScaledWidth() - 15, Minecraft.getInstance().getMainWindow().getScaledHeight() - 15, 15, new ResourceLocation("bedres", "textures/gui/flux_oracle_book_info_gui.png"));
            drawModalRectWithCustomSizedTexture(5+((Minecraft.getInstance().getMainWindow().getScaledWidth())/8.0f)-32, 5+ ((Minecraft.getInstance().getMainWindow().getScaledWidth())/8.0), (5+((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6.0)) + 32, 5+((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6.0f),
                    new ResourceLocation("bedres", "textures/gui/widget/scraper.png"));
            drawString(minecraft.fontRenderer,"Bedrock Scrapper:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            drawString(minecraft.fontRenderer,"Blazium:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            drawString(minecraft.fontRenderer,"Ender Hush:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            drawString(minecraft.fontRenderer,"Sun Daize:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            drawString(minecraft.fontRenderer,"Enderian Ore:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            drawString(minecraft.fontRenderer,"Enderian Ingot:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            renderString(s,12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),Minecraft.getInstance().getMainWindow().getScaledWidth()-30);
            renderString(ss,28+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-53))-55,Minecraft.getInstance().getMainWindow().getScaledWidth()-30,16766720);
        }else if (tank){
            drawModalRectWithCustomSizedTexture(15, Minecraft.getInstance().getMainWindow().getScaledWidth() - 15, Minecraft.getInstance().getMainWindow().getScaledHeight() - 15, 15, new ResourceLocation("bedres", "textures/gui/flux_oracle_book_info_gui.png"));
            drawModalRectWithCustomSizedTexture(5+((Minecraft.getInstance().getMainWindow().getScaledWidth())/8.0f)-32, 5+ ((Minecraft.getInstance().getMainWindow().getScaledWidth())/8.0), (5+((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6.0)) + 32, 5+((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6.0f),
                    new ResourceLocation("bedres", "textures/gui/widget/tank.png"));
            drawString(minecraft.fontRenderer,"Scrapes Tank:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            drawString(minecraft.fontRenderer,"Bedrock Flux:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            drawString(minecraft.fontRenderer,"Item Platform:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            drawString(minecraft.fontRenderer,"Enderian Rirual Platform:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            renderString(sw,12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/2),Minecraft.getInstance().getMainWindow().getScaledWidth()-30);
            next.renderButton(p_render_1_, p_render_2_, p_render_3_);

        }else if (ritualped2){
            drawModalRectWithCustomSizedTexture(15, Minecraft.getInstance().getMainWindow().getScaledWidth() - 15, Minecraft.getInstance().getMainWindow().getScaledHeight() - 15, 15, new ResourceLocation("bedres", "textures/gui/flux_oracle_book_info_gui.png"));
            drawModalRectWithCustomSizedTexture(Minecraft.getInstance().getMainWindow().getScaledWidth()/2.0, Minecraft.getInstance().getMainWindow().getScaledWidth()-32, (Minecraft.getInstance().getMainWindow().getScaledHeight()-32) , 32,
                    new ResourceLocation("bedres", "textures/gui/ritual_upgrades.png"));
            drawString(minecraft.fontRenderer,"General Upgrade Ritual:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            renderTitleItem(new ArrayList<Item>(){{add(Items.WOODEN_AXE);add(Items.WOODEN_PICKAXE);add(Items.WOODEN_SWORD);add(Items.WOODEN_SHOVEL);add(Items.DIAMOND_HOE);add(ModItems.enderianIngot);}},12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6));
            renderString("This pattern seems to be the most used, a pattern where one can put 4 of any tool (any material but all 4 the same) will infuse you with the attributes of the chosen material.",
                    12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/20), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/4),Minecraft.getInstance().getMainWindow().getScaledWidth() -(Minecraft.getInstance().getMainWindow().getScaledWidth()/4) - 55);
            renderString("The hoe seems to be the exception, it'll only accept diamond hoes and infuse you with its ability; besides, whats the use of a wooden hoe.",
                    12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/20), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/2),Minecraft.getInstance().getMainWindow().getScaledWidth() -(Minecraft.getInstance().getMainWindow().getScaledWidth()/4));
            renderString("The diamond Shovel seems to also infuse you with its path making ability",
                    12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/20), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/2) + ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),Minecraft.getInstance().getMainWindow().getScaledWidth() -(Minecraft.getInstance().getMainWindow().getScaledWidth()/4));
            ...
            drawString(minecraft.fontRenderer,"Jump Upgrade Ritual:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);

            renderTitleItem(new ArrayList<Item>(){{add(Items.PISTON);add(Items.RABBIT_FOOT);add(ModItems.enderianIngot);}},12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6));
            ...
            drawString(minecraft.fontRenderer,"Mining Speed Upgrade Ritual:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            renderTitleItem(new ArrayList<Item>(){{add(Items.SUGAR);add(Items.REDSTONE);add(Items.COOKIE);add(ModItems.fluxedCupcake);add(ModItems.enderianIngot);}},12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6));
            renderString("This pattern also came to be by studying the upgrade pattern. It seems placing sugar on the north and a fluxed cupcake on the south pedestal and cookies and redstone on west and east respectively, will make you mine slightly faster.",
                    12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/20), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/4),Minecraft.getInstance().getMainWindow().getScaledWidth() -(Minecraft.getInstance().getMainWindow().getScaledWidth()/4) - 85);
        }else if (ritualped5){
            drawModalRectWithCustomSizedTexture(15, Minecraft.getInstance().getMainWindow().getScaledWidth() - 15, Minecraft.getInstance().getMainWindow().getScaledHeight() - 15, 15, new ResourceLocation("bedres", "textures/gui/flux_oracle_book_info_gui.png"));
            drawModalRectWithCustomSizedTexture(Minecraft.getInstance().getMainWindow().getScaledWidth()/2.0, Minecraft.getInstance().getMainWindow().getScaledWidth()-32, (Minecraft.getInstance().getMainWindow().getScaledHeight()-32) , 32,
                    new ResourceLocation("bedres", "textures/gui/ritual_day.png"));
            drawString(minecraft.fontRenderer,"Day Time Ritual:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            renderTitleItem(new ArrayList<Item>(){{add(Items.GLOWSTONE);add(Item.getItemFromBlock(ModBlocks.sunDaize));}},12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6));
            ...
            drawString(minecraft.fontRenderer,"Night Time Ritual:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            renderTitleItem(new ArrayList<Item>(){{add(Items.INK_SAC);add(Item.getItemFromBlock(ModBlocks.dfOakSappling));}},12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6));
            ...
            drawString(minecraft.fontRenderer,"Rain Ritual:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);

            renderTitleItem(new ArrayList<Item>(){{add(Items.SUGAR_CANE);add(Items.WATER_BUCKET);}},12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6));
            ...
            drawString(minecraft.fontRenderer,"Clear Rain Ritual:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            renderTitleItem(new ArrayList<Item>(){{add(Items.DRIED_KELP);add(Items.BUCKET);}},12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6));
            ...
            drawString(minecraft.fontRenderer,"Flight Ritual:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            renderTitleItem(new ArrayList<Item>(){{add(Items.NETHER_STAR);add(Items.ELYTRA);add(ModItems.nebulaHeart);add(ModItems.enderianIngot);add(Item.getItemFromBlock(ModBlocks.fluxedGravityBubble));}},12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6));
            ...
            drawString(minecraft.fontRenderer,"Fluxed Spores:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            drawString(minecraft.fontRenderer,"Fluxed Cupcake:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            drawModalRectWithCustomSizedTexture(((Minecraft.getInstance().getMainWindow().getScaledWidth()/2)), ((Minecraft.getInstance().getMainWindow().getScaledWidth())-32), (((Minecraft.getInstance().getMainWindow().getScaledHeight()-64))) + 32, (((Minecraft.getInstance().getMainWindow().getScaledHeight()-64))) + 16 - (Minecraft.getInstance().getMainWindow().getScaledHeight()/3),
                    new ResourceLocation("bedres", "textures/gui/compressed_ritual.png"));
            drawString(minecraft.fontRenderer,"Bedrock Compressed Wire:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            drawString(minecraft.fontRenderer,"Fluxed Gravity Bubble:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            drawString(minecraft.fontRenderer,"Gravity Staff:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
            ...
            drawString(minecraft.fontRenderer,"Nebula Heart:",12+((Minecraft.getInstance().getMainWindow().getScaledWidth()-15)/8), ((Minecraft.getInstance().getMainWindow().getScaledHeight()-15)/6),1111111);
